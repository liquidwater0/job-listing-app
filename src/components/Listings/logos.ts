...
//need this here so logo files load into assets folder
[accountLogo, eyecamLogo, faceitLogo, insureLogo, loopStudiosLogo,manageLogo, myHomeLogo, photosnap, shortly, airFilterLogo];